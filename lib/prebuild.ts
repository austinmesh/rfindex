/**
 * Prebuild script: reads device and antenna JSON files from the rfindex-data directory
...
const devicesDir = path.join(process.cwd(), "rfindex-data", "data", "meshtastic_devices")

if (!fs.existsSync(devicesDir)) {
  console.error("rfindex-data submodule not found at", devicesDir)
  process.exit(1)
}
...
// Auto-generated from rfindex-data/. Do not edit manually.
