...
| Rokland | [rokland.goaffpro.com](https://rokland.goaffpro.com/) | `?ref=rfindex` query param | `https://store.rokland.com/products/...?ref=rfindex` |
| Seeed Studio | [seeedstudio.com/sensecap/account/program](https://www.seeedstudio.com/sensecap/account/program/) | `?sensecap_affiliate=WMeIXYu&referring_service=link` | `https://www.seeedstudio.com/...?sensecap_affiliate=WMeIXYu&referring_service=link` |
| Elecrow | — | `?ref=rfindex` query param | `https://www.elecrow.com/...?ref=rfindex` |

## Stores Without Affiliate Programs
...
When adding a new purchase URL for a supported store, always include the appropriate referral parameters. For shortlink-based programs (Amazon, AliExpress, RAKwireless), generate a new tracking link through the program dashboard.
